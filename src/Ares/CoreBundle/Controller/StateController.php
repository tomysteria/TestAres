...
use Ares\CoreBundle\Entity\State;
use Ares\CoreBundle\Form\StateType;
...
class StateController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AresCoreBundle:State')->findAll();
     ...
     * @Method("POST")
     * @Template("AresCoreBundle:State:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AresCoreBundle:State')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AresCoreBundle:State:edit.html.twig")
     */
